...
export default function RegisterScreen() {
  ...
  async function register() {
    ...
    if (!accepted) {
      showModal({ icon: '📋', title: 'Conditions requises', message: 'Tu dois accepter les conditions d\'utilisation pour créer un compte.' }); return;
    }
      ...
      <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
        ...
        {step === 2 && (
          <View style={styles.form}>
            ...
            {/* CGU */}
            <TouchableOpacity style={styles.cguRow} onPress={() => setAccepted(a => !a)} activeOpacity={0.7}>
              <View style={[styles.checkbox, accepted && styles.checkboxChecked]}>
                {accepted && <Text style={styles.checkmark}>✓</Text>}
              </View>
              <Text style={styles.cguText}>
                J'accepte les{' '}
                <Text style={styles.cguLink} onPress={() => router.push({ pathname: '/(parent)/legal', params: { type: 'terms' } })}>
                  conditions d'utilisation
                </Text>
                {' '}et la{' '}
                <Text style={styles.cguLink} onPress={() => router.push({ pathname: '/(parent)/legal', params: { type: 'privacy' } })}>
          ...
          <View style={styles.form}>
            ...
            <View style={styles.fieldWrap}>
              ...
              <TextInput
                ...
                textAlign="center"
              />
              <Text style={styles.codeHint}>Le code expire dans 10 minutes</Text>
            </View>
            ...
            <TouchableOpacity style={styles.backBtn} onPress={() => setStep(2)} activeOpacity={0.7}>
              <Text style={styles.backBtnText}>← Modifier mon email</Text>
            </TouchableOpacity>
          </View>
        )}
